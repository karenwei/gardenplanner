...
class VegetablesControllerTest < ActionController::TestCase
  ...
  test "should create vegetable" do
    assert_difference('Vegetable.count') do
      post :create, vegetable: { beans: @vegetable.beans, chive: @vegetable.chive, dill: @vegetable.dill, onion: @vegetable.onion, potato: @vegetable.potato, tomato: @vegetable.tomato }
    end
  ...
  test "should update vegetable" do
    put :update, id: @vegetable, vegetable: { beans: @vegetable.beans, chive: @vegetable.chive, dill: @vegetable.dill, onion: @vegetable.onion, potato: @vegetable.potato, tomato: @vegetable.tomato }
    assert_redirected_to vegetable_path(assigns(:vegetable))
  end
